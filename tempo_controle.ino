...
unsigned long tempo = 0, tempo_amostra = 1000, t0 = 0, tempo_2 = 0, t_function = 0, t_pulse = 0, time1 = 0, time2 = 0;
...
void loop()
{
  ...
  Serial.print("Tempo gasto pela tarefa (em microssegundos): ");
  Serial.print(time1); 

  Serial.print(" | ");
  Serial.print("Tempo da contagem de pulsos (em microssegundos): ");
